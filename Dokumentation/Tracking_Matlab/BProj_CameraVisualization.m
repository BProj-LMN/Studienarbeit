...
CoordSys = baseXaxis;
plotable = BProj_makeRay(CoordSys); plot3(plotable(1,:),plotable(2,:),plotable(3,:),'r');
CoordSys = baseYaxis;
plotable = BProj_makeRay(CoordSys); plot3(plotable(1,:),plotable(2,:),plotable(3,:),'g');
CoordSys = baseZaxis;
plotable = BProj_makeRay(CoordSys); plot3(plotable(1,:),plotable(2,:),plotable(3,:),'b');
...
plotable = BProj_translateRay(BProj_makeRay(CoordSys), cam1_o'); plot3(plotable(1,:),plotable(2,:),plotable(3,:),'r');
CoordSys = baseYaxis;
plotable = BProj_translateRay(BProj_makeRay(CoordSys), cam1_o'); plot3(plotable(1,:),plotable(2,:),plotable(3,:),'g');
CoordSys = baseZaxis;
plotable = BProj_translateRay(BProj_makeRay(CoordSys), cam1_o'); plot3(plotable(1,:),plotable(2,:),plotable(3,:),'b');

% Word Coordinate System at Camera 2 Position
CoordSys = baseXaxis / 4;
plotable = BProj_translateRay(BProj_makeRay(CoordSys), cam2_o'); plot3(plotable(1,:),plotable(2,:),plotable(3,:),'r');
CoordSys = baseYaxis;
plotable = BProj_translateRay(BProj_makeRay(CoordSys), cam2_o'); plot3(plotable(1,:),plotable(2,:),plotable(3,:),'g');
CoordSys = baseZaxis;
plotable = BProj_translateRay(BProj_makeRay(CoordSys), cam2_o'); plot3(plotable(1,:),plotable(2,:),plotable(3,:),'b');
...
%plotable = BProj_translateRay(BProj_makeRay(cam1_ViewingPlane), cam1_o');  plot3(plotable(1,:),plotable(2,:),plotable(3,:),'k');
...
plotable = BProj_translateRay(BProj_makeRay(point_cam1), cam1_o');  plot3(plotable(1,:),plotable(2,:),plotable(3,:),'k');
...
plotable = BProj_translateRay(BProj_makeRay(system), cam1_o');  plot3(plotable(1,:),plotable(2,:),plotable(3,:),'r');
system = rotate3_euler(cam1_w3) * rotate2_euler(cam1_w2) * rotate1_euler(cam1_w1) * baseYaxis/2;
plotable = BProj_translateRay(BProj_makeRay(system), cam1_o');  plot3(plotable(1,:),plotable(2,:),plotable(3,:),'g');
system = rotate3_euler(cam1_w3) * rotate2_euler(cam1_w2) * rotate1_euler(cam1_w1) * baseZaxis/2;
plotable = BProj_translateRay(BProj_makeRay(system), cam1_o');  plot3(plotable(1,:),plotable(2,:),plotable(3,:),'b');
...
%plotable = BProj_translateRay(BProj_makeRay(cam2_ViewingPlane), cam2_o');  plot3(plotable(1,:),plotable(2,:),plotable(3,:),'k');

% -- transform some point to camera coordinates
point_cam2 = rotate3_euler(cam2_w3) * rotate2_euler(cam2_w2) * rotate1_euler(cam2_w1) * point_cam2;
plotable = BProj_translateRay(BProj_makeRay(point_cam2), cam2_o');  plot3(plotable(1,:),plotable(2,:),plotable(3,:),'k');

% -- visualization of translated coordinate system
system = rotate3_euler(cam2_w3) * rotate2_euler(cam2_w2) * rotate1_euler(cam2_w1) * baseXaxis/2;
plotable = BProj_translateRay(BProj_makeRay(system), cam2_o');  plot3(plotable(1,:),plotable(2,:),plotable(3,:),'r');
system = rotate3_euler(cam2_w3) * rotate2_euler(cam2_w2) * rotate1_euler(cam2_w1) * baseYaxis/2;
plotable = BProj_translateRay(BProj_makeRay(system), cam2_o');  plot3(plotable(1,:),plotable(2,:),plotable(3,:),'g');
system = rotate3_euler(cam2_w3) * rotate2_euler(cam2_w2) * rotate1_euler(cam2_w1) * baseZaxis/2;
plotable = BProj_translateRay(BProj_makeRay(system), cam2_o');  plot3(plotable(1,:),plotable(2,:),plotable(3,:),'b');
